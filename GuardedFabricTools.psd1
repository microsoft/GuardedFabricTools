...
Description = 'Tools to help you deploy shielded virtual machines and manage guarded fabrics.'
...
FormatsToProcess = @(
    "./AttestationReport/AttestationReport.format.ps1xml"
    )
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/Microsoft/GuardedFabricTools/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/Microsoft/GuardedFabricTools'
